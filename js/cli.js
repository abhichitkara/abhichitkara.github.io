...
const struct = {
    root: ['about', 'resume', 'contact', 'education', 'experience', 'publications', 'hacktivity', 'certifications'],
    projects: ['R&D', 'breakingDES', 'networksec', 'ShareCart', 'SmartDoorbell'],
    skills: ['proficient', 'comfortable', 'familiar', 'others']
}

const commands = {}
let systemData = {}
const rootPath = 'user/abhic/root'
